...
import KswapV2Factory from '@kimchiswap/v2-core/build/KswapV2Factory.json'
import KswapV2Pair from '@kimchiswap/v2-core/build/KswapV2Pair.json'
...
describe('scenario:FeeTo', () => {
  ...
  beforeEach('deploy kswap v2', async () => {
    factory = await deployContract(wallet, KswapV2Factory, [wallet.address])
  })
  ...
  describe('tokens', () => {
    ...
    beforeEach('create fee liquidity', async () => {
      ...
      pair = new Contract(pairAddress, KswapV2Pair.abi).connect(wallet)
